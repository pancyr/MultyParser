...
{
    public class ExcelTovarPropertyDecimal : ExcelTovarPropertyBase
    {
        public ExcelTovarPropertyDecimal(string name, string group, int column) : base(name, group, column) { }

        public ExcelTovarPropertyDecimal(string name, string group, List<int> columns) : base(name, group, columns) { }
