...
namespace MultyParser.Core.Excel
{
    ...
    {
        public ExcelPage(Worksheet sheet, Styles styles = null)
        {
        ...
        {
            this.TotalRows = _excelSheet.Cells.Find("*", System.Reflection.Missing.Value,
                System.Reflection.Missing.Value, System.Reflection.Missing.Value,
                XlSearchOrder.xlByRows, XlSearchDirection.xlPrevious,
                false, System.Reflection.Missing.Value, System.Reflection.Missing.Value).Row;

            // Найти последний заполненый столбец
            this.TotalColumns = _excelSheet.Cells.Find("*", System.Reflection.Missing.Value,
                System.Reflection.Missing.Value, System.Reflection.Missing.Value,
        ...
        public void CentrateRow(int row)
        {
            Range cell = _excelSheet.Cells[row, 1];
            cell.EntireRow.EntireRow.VerticalAlignment = XlVAlign.xlVAlignCenter;
            cell.EntireRow.EntireRow.HorizontalAlignment = XlHAlign.xlHAlignCenter;
        }
        ...
        public bool MakeColumnStringFormat(int columnNum)
        {
            _excelSheet.Cells[1, columnNum].EntireColumn.NumberFormat = "@";
            return true;
        }
